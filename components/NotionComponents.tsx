...
export const getComponents = (customComponents: Partial<Components> = {}) => ({
  ...defaultComponents,
  ...customComponents,
});

export const getNotionProps = ({ site, recordMap, pageId }): any => {
  const lite = useSearchParam("lite");

  const components = React.useMemo(getComponents, []);
